...
class CreateMailboxer < ActiveRecord::Migration
  def self.up
    # Tables
    # Conversations
    create_mailboxer_conversations_table

    # Receipts
    # Notifications and Messages
    create_mailboxer_receipts_table
    create_mailboxer_notifications_table
    # Indexes
    # Conversations
    # Receipts
  ...
  def create_mailboxer_conversations_table
  ...
  def create_mailboxer_receipts_table
  ...
  def create_mailboxer_notifications_table
